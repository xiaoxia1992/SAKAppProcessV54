...
#define XPOSED_DIR "/system/"
#define XPOSED_JAR XPOSED_DIR "framework/xposed.jar"
#define XPOSED_JAR_NEWVERSION XPOSED_DIR "framework/XposedBridge.jar.newversion"
